 ...
 * @see Loader
 */
public class DiyTextDirectoryLoader extends AbstractLoader implements
	...
	public static void main(String[] args) {
		if (args.length > 0) {
			...
			Enumeration enm = ((OptionHandler) new DiyTextDirectoryLoader())
					.listOptions();
			while (enm.hasMoreElements()) {
