 ...
 * @see Loader
 */
public class WekaDiyTextDirectoryLoader extends AbstractLoader implements
		BatchConverter, OptionHandler {
	 ...
	 * default constructor
	 */
	public WekaDiyTextDirectoryLoader() {
	 ...
	 * indicates that the default character set will be used.
	 * 
	 * @return the character set name to use (or empty string to indicate that
	...
	public Instances getStructure() throws IOException {
		...
		if (m_structure == null) {
			...
			for (int i = 0; i < subdirs.length; i++) {
				File subdir = new File(directoryPath + File.separator
						+ subdirs[i]);
			...
			// clash with any attribute created via the StringToWordVector
			// filter
	 ...
	 * @throws IOException
	 *             always. TextDirectoryLoader is unable to process a data set
	 *             incrementally.
	 */
	public Instance getNextInstance(Instances structure) throws IOException {
		throw new IOException(
				"TextDirectoryLoader can't read data sets incrementally.");
	}
	...
	public static void main(String[] args) {
		if (args.length > 0) {
			...
			Enumeration enm = ((OptionHandler) new WekaDiyTextDirectoryLoader())
					.listOptions();
			while (enm.hasMoreElements()) {
